# 1.2.600 Инженерные конструкции, применяемые для предотвращения проникновения злоумышленника к источникам информации.
## Содержание
...
**Полупрофильный урникет** — конструктивно напоминает хорошо знакомую «вертушку». Обеспечивает большую степень защищенности, чем трипод, но требует большего пространства для установки.
...
## Вопросы
1. Назовите два вида преград 
  - электрические и механические
  - физические и нефизические
  - **естественные и искусственные**

2. Выберите верное утверждение
  - чем больше время перемещения его на охраняемой территории, тем меньше вероятность его обнаружения и нейтрализации
  - **чем больше время перемещения нарушителя на охраняемой территории, тем выше вероятность его обнаружения и нейтрализации**
  - чем меньше время перемещения нарушителя на охраняемой территории, тем выше вероятность его обнаружения и нейтрализации
  
3. Какой вид турникета больше всего подходит под это описание "Турникет с вращающимися преграждающими планками. Является наиболее популярным типом турникета. Это обусловлено его невысокой стоимостью, компактностью, возможностью гармонично вписать в любой интерьер. Устанавливается в местах постоянного присутствия сотрудника охраны."?
  - Калитка
  - Полупрофильный турникет
  - **Трипод**
 
4. Сколько видов современных замков для дверей существует?
  - 1
  - 2
  - 3
  - **4**
...
2. **[Studfile.net](https://studfile.net/preview/4170604/page:5/)**   
